...
class dovo_mainFrame : public mainFrame
{
	protected:
		...
		void OnInstancesRightClick(wxListEvent& event);
		void OnSendStudy(wxCommandEvent& event);
		void OnSendSeries(wxCommandEvent& event);
		void OnCopyStudyUID(wxCommandEvent& event);
		void OnCopySeriesUID(wxCommandEvent& event);
		void OnCopySOPUID(wxCommandEvent& event);
	public:
		/** Constructor */
